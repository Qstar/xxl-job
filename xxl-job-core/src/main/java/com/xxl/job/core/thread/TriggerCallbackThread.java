...
public class TriggerCallbackThread {
    ...
    private static String failCallbackFileName = XxlJobFileAppender.getLogPath().concat(File.separator).concat("xxl-job-callback").concat(
            ".log");
    ...
    private void retryFailCallbackFile() {
        ...
        if (CollectionUtils.isNotEmpty(failCallbackParamList)) {
            int pagesize = 100;
